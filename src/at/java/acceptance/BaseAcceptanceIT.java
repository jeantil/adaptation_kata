...
public class BaseAcceptanceIT {
    ...
    AnnotationConfigApplicationContext initializeApplication() {
        ...
        mockEnvironment.setProperty("filename.base", "file://");
        ctx.setEnvironment(mockEnvironment);
        ctx.refresh();
        return ctx;
    }

    JsonNode readStoredFile(AnnotationConfigApplicationContext ctx) throws IOException {
